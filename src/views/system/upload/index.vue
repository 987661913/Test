      ...
      <el-main>
        <el-scrollbar class="scroll-container">
          <div :style="{'padding-right':rightPadding+'px'}" class="scroll-container-wrap">
            ...
            <el-input placeholder="请输入内容" style="width:240px;float:left;margin-right: 20px;" v-if="fileListId" v-model="searchList"></el-input>
            ...
            <el-table :data="categoryFileList" style="width: 100%;margin-top: 20px;" tooltip-effect="dark">
              ...
              <el-table-column label="操作">
                <template slot-scope="scope"> 
                  <el-button type="text" size="small" @click="deleteList(scope.row.id)">删 除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
